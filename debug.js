...
// 气泡图 bubble
var __initBubble__ = function(Data, Dom) {
    log(Data[0])
    var title = Data[0].title
    var list = []
    var className = []
...
// funnel 漏斗图
var __initFunnel__ = function(Data, Dom) {
    var title = Data[0].title
    var Data = Data[0].data
    var className = []
    for (var i of Data) {
...
var __init__ = function() {
    ...
    __initFunnel__(Data(data, funnelModel), $('#id-funnel')[0])
    __initBubble__(Data(data, bubbleModel), $('#id-bubble')[0])
    // 气泡图DATA (Model自己编)
    var bubbleData = [{
        'class': '2048',
        'shuju': [
